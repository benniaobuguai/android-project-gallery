...
import com.wo2b.gallery.business.base.BusinessData;
import com.wo2b.gallery.business.localalbum.LocalImageFactory;
import com.wo2b.gallery.global.GIntent;
import com.wo2b.gallery.model.localalbum.FocusItemInfo;
import com.wo2b.gallery.ui.fileexplorer.FileExplorerActivity;
...
public class LocalAlbumFocusListActivity extends BaseFragmentActivity
{
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data)
	{
		...
		if (resultCode == RESULT_OK)
		{
			...
			{
				final String directory = data.getStringExtra(GIntent.EXTRA_DIRECTORY);
				final String title = data.getStringExtra(GIntent.EXTRA_TITLE);
