...
import com.opencdk.umeng.MobclickAgentProxy;
import com.opencdk.umeng.UmengUpdateAgentProxy;
import com.opencdk.util.log.Log;
import com.wo2b.gallery.R;
import com.wo2b.gallery.ui.baike.BaikeFragment;
import com.wo2b.gallery.ui.blossom.BlossomHomeFragment;
import com.wo2b.gallery.ui.settings.SettingsActivity;
import com.wo2b.gallery.ui.uc.UserCenterFragment;
import com.wo2b.wrapper.app.TabFragmentActivity;
import com.wo2b.wrapper.view.dialog.BottomMenu;
import com.wo2b.wrapper.view.dialog.BottomMenu.OnBottomMenuClick;
import com.wo2b.wrapper.view.dialog.DialogProgressBar;
 ...
 * @date 2014-11-9
 */
public class HomeActivity extends TabFragmentActivity
{
	...
	private BottomMenu createBottomMenu()
	{
				...
				public void onClick(final BottomMenu bottomMenu, int which)
				{
					switch (which)
					{
						case R.string.quit:
						{
							...
							DialogProgressBar exitDialog = DialogUtils.createLoadingDialog(mContext, warn);
							exitDialog.setCancelable(true);
							exitDialog.setAutoWidth(true);
