...
import com.wo2b.gallery.business.data.RestoreManager;
import com.wo2b.gallery.global.GApplication;
import com.wo2b.gallery.global.provider.DataProvider;
import com.wo2b.gallery.ui.settings.LockViewActivity;
...
public class SplashActivity extends BaseFragmentActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		{
			// 检查锁
			mSavedPwd = XPreferenceManager.getString("entry_password", "");
	...
	private final Runnable mSystemInit = new Runnable()
	{
		...
		private void loadData()
		{
			...
			provider.init(GApplication.getGApplication());
		...
		private void afterSystemLoaded(long startTime, long endTime)
		{
			...
			final int latestVersion = CDK.getInstance().getCDKContext().getAppVersionCode();
