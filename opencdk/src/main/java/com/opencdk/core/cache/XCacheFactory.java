package com.opencdk.core.cache;
...
public class XCacheFactory
{
	 ...
	 * www.wo2b.com系统级基目录
	 */
	private static final String wo2bDir = CDKConfig.APP_DIR + "/";
	 ...
	 * www.wo2b.com缺省的目录地址
	 */
	//public static final String WO2B_DIR = CDKConfig.WO2B_DIR;
	 ...
	 */
	public XCacheFactory(String appName)
	{
	...
	/**
	 * 构造函数, 不推荐使用此构造方法, 请使用{@linkp AbsXCacheFactory#AbsXCacheFactory(String)}
	 * 
	 * @param wo2bDir 基础目录
	 * @param appName 应用程序名称
	 */
	@Deprecated
	public XCacheFactory(String wo2bDir, String appName)
	{
