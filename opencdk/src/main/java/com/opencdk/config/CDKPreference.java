...
import com.opencdk.util.DateUtils;
...
public class CDKPreference
{
	...
	public static SharedPreferences getTemp()
	{
		if (mTempPref == null)
		{
			mTempPref = CDK.getInstance().getContext().getSharedPreferences("com.wo2b.temp", Context.MODE_PRIVATE);
		}
	...
	public static SharedPreferences getPrefSystem()
	{
		if (mSystemPref == null)
		{
			mSystemPref = PreferenceManager.getDefaultSharedPreferences(CDK.getInstance().getContext());
		}
	...
	{
		return CDK.getInstance().getContext().getResources().getString(resId);
	}
	
	
	// -------------------------------- High Frequency --------------------------------
	/** 应用版本 */
	public static final String PREF_APP_VERSION = "wo2b_app_version";
	/** 统计使用次数, 总数 */
	public static final String PREF_USE_TOTAL_COUNT = "wo2b_use_total_count";
	/** 统计使用次数, 每天只统计一次 */
	public static final String PREF_USE_DAY_COUNT = "wo2b_use_day_count";
	/** 统计使用次数的日期 */
	public static final String PREF_USE_DAY_COUNT_DATE = "wo2b_use_day_count_date";
	...
	public static String getDeviceGUID()
	{
		...
		{
			deviceGUID = DeviceInfoManager.getDeviceGUID(CDK.getInstance().getContext());
