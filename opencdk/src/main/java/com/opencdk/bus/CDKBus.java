 ...
 * 
 */
public final class CDKBus
{

	private static volatile CDKBus mInstance = null;
	...
	private static CDKBus getInstance()
	{
		if (mInstance == null)
		{
			synchronized (CDKBus.class)
			{
				if (mInstance == null)
				{
					mInstance = new CDKBus();
				}
			}
		}
