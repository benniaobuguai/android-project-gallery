...
public abstract class AutoScrollableView<T> extends AutoScrollViewPager implements IPagerAdapter
{
	...
	/* (non-Javadoc)
	 * @see com.opencdk.view.viewpager.IPagerAdapter#destroyItem(android.view.ViewGroup, int, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.opencdk.view.viewpager.IPagerAdapter#getCount()
	 */
	@Override
	public int getCount()
	{
...
//	/* (non-Javadoc)
//	 * @see com.opencdk.view.viewpager.IPagerAdapter#instantiateItem(android.view.ViewGroup, int)
//	 */
//	@Override
...
//	}
	...
	/* (non-Javadoc)
	 * @see com.opencdk.view.viewpager.IPagerAdapter#isViewFromObject(android.view.View, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.opencdk.view.viewpager.IPagerAdapter#restoreState(android.os.Parcelable, java.lang.ClassLoader)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.opencdk.view.viewpager.IPagerAdapter#saveState()
	 */
	@Override
