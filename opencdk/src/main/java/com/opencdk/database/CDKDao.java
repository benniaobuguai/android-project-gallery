 ...
 * @param <Model>
 */
public abstract class CDKDao<Model>
{
	
	private static final String TAG = "CDK.Dao";
	...
	public CDKDao(OrmLiteSqliteOpenHelper sqliteOpenHelper)
	{
