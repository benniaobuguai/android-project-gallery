 ...
 * @param <Model>
 */
public abstract class BaseListFragment<Model> extends BaseFragment implements OnPullToRefreshListener
{
	 ...
	 * @return
	 */
	public abstract View realOnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState);
	 ...
	 * @param savedInstanceState
	 */
	public abstract void realOnCreateViewComplete(View view, Bundle savedInstanceState);
	...
	{
		View view = realOnCreateView(inflater, container, savedInstanceState);
		
		mRecyclerListView = findViewByIdExt(view, R.id.wo2b_listview);
		...
		mRecyclerViewAdapter = new RecyclerViewListAdapter<Model>(new WeakReference<BaseListFragment<Model>>(this),
		        mListData);
	...
	public static class RecyclerViewListAdapter<ITEM> extends RecyclerViewAdapter<ITEM>
	{
		...
		private WeakReference<BaseListFragment<ITEM>> mWeakReference;
		
		public RecyclerViewListAdapter(WeakReference<BaseListFragment<ITEM>> weakReference, List<ITEM> items)
		{
			super(weakReference.get().getActivity(), items);
	...
	{
		realOnPullDownToRefresh(mRecyclerListView, null);
	}
	
	@Override
	public void onPullUpToRefresh(View view)
	{
		realOnPullUpToRefresh(mRecyclerListView, null);
	}
