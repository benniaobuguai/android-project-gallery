...
import com.wo2b.wrapper.app.support.TabItem;

/**
 * Tab FragmentActivity
 * 
 * @author 笨鸟不乖
...
public class TabFragmentActivity extends BaseFragmentActivity
{
	...
	public static final String TAG = "Wrapper.TabFragmentActivity";
	...
	private void setUpView()
	{
		...
		mTabHost = (LinearLayout) findViewById(R.id.wo2b_tabhos);
		...
		pageIndicator.setOnPageChangeListener(new OnPageChangeListener()
		{
			...
			public void onPageSelected(int position)
			{
				...
				{
					tabItemView = (TextView) mTabHost.getChildAt(i);
	...
	public void fillTabLayout()
	{
		...
		for (int i = 0; i < size; i++)
		{
			...
			mTabHost.addView(tabItemView, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
					LinearLayout.LayoutParams.WRAP_CONTENT, 1));
		}
		mTabHost.setWeightSum(size);
