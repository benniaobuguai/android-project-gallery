 ...
 * @Modify 2015-11-14
 */
public class BrowserFragmentActivity extends BaseFragmentActivity implements OnClickListener
{
	...
	{
		mWebView = (WebView) findViewById(R.id.wo2b_webview);
		...
		mWebView.setDownloadListener(new DownloadListener()
		{
					...
					long contentLength)
			{
				...
				{
					String saveDirectory = XCacheFactory.getWo2bDownloadDir() + "www.wo2b.com";
	...
	public static class MyWebChromeClient extends WebChromeClient
	{
		...
		private BrowserFragmentActivity mWebViewActivity;

		public MyWebChromeClient(BrowserFragmentActivity webViewActivity)
		{
