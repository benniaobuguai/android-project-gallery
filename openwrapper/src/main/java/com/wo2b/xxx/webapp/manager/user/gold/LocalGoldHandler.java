...
//import com.opencdk.common.util.io.StreamUtils;
//import com.opencdk.core.CDKConfig;
//import com.opencdk.core.security.RockySecurity;
...
//	{
//		// OK
//		return new File(CDKConfig.getRockyDataTemp() + "/7axzchjervizildmzb7s0k2ok");
//	}
//
//	/**
//	 * 没有登录的金币信息文件
...
//	{
//		// NO
//		return new File(CDKConfig.getRockyDataTemp() + "/7axzchjervizildmzb7s0k2no");
//	}
//
//	// 本地积分存储
//
